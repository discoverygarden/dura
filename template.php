 ...
 *   entirety and paste it here, changing the prefix from theme_ to dura_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: dura_breadcrumb()
 *
 *   where dura is the name of your sub-theme. For example, the
 ...
 */
function dura_theme(&$existing, $type, $theme, $path) {
...
function dura_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function dura_preprocess_page(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function dura_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');

  // Optionally, run node-type-specific preprocess functions, like
  // dura_preprocess_node_page() or dura_preprocess_node_story().
 ...
 */
/* -- Delete this line if you want to use this function
function dura_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function dura_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
